...
How good was your model at correctly predicting who would and who would not accept the offer?
...
$$\text{Accuracy} = \frac{\text{\small{TP}} + \text{TN}}{\text{TP}+\text{TN}+\text{FP}+\text{FN}}$$ 
